...
#define DC_TARGET_VAR_KEY_OFFSET_BASE	DC_TARGET_VAR_KEY_BASE_ID + 3
#define DC_TARGET_VAR_KEY_OFFSET_X		DC_TARGET_VAR_KEY_BASE_ID + 4
#define DC_TARGET_VAR_KEY_OFFSET_Y		DC_TARGET_VAR_KEY_BASE_ID + 5
#define DC_TARGET_VAR_KEY_OFFSET_Z		DC_TARGET_VAR_KEY_BASE_ID + 6
